...
class ModelManager:
    ...
    def __init__(self, base_dir: Path):
        ...
        # No separate cache needed - models are already stored persistently
        # in the actual model directories which are symlinked to /runpod
        self.using_network_volume = Path('/runpod').exists()
